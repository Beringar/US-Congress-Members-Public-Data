				...
				xhr: function () {
					...
					xhr.addEventListener("progress", function (evt) {
						if (evt.lengthComputable) {
							...
							console.log("Fetched data: " + (percentComplete * 100).toFixed(2) + " %");
							$('.progress').css({
								width: percentComplete * 100 + '%'
							}).text((percentComplete * 100).toFixed(2) + " %");
